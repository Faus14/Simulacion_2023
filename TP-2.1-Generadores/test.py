"""RNG quality tests"""
import numpy as np
from scipy.stats import ksone, norm, chi2, binom, nbinom
from math import sqrt, trunc
import matplotlib.pyplot as plt

"""Code from following functions is based on: https://github.com/nicolasf96/practica-simulacion-2022/blob/main/Generators/tests.py
...
def KolmogorovTest2(lista, alfa, dist_type):
